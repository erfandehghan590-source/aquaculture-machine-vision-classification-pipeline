...
# مقادیر پیش‌فرض در صورت عدم وجود در فایل کانفیگ
...
class ProtoNet(nn.Module):
    """معماری بر پایه نگاشت ویژگی‌های ResNet50 به فضای متریک"""
...
def get_resnet_target_layers(model: nn.Module):
    """تعیین آخرین بلوک کانولوشنی (layer4) برای استخراج گرادیان Grad-CAM"""

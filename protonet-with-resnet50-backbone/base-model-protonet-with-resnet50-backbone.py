...
# DataLoader for calculating fixed prototypes from the training set (no shuffle)
...
# =====================================================================
# ProtoNet Architecture (ResNet50 Backbone)
# =====================================================================
...
def main():
    ...
    if MODE == "train":
        ...
        # Restore best weights and prototypes

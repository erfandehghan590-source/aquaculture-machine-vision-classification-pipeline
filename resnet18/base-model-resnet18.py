...
# =====================================================================
def build_resnet18_model(num_classes: int = 2) -> nn.Module:
    """بارگذاری ResNet18 پیش‌آموزش‌دیده و تنظیم لایه طبقه‌بندی نهایی"""
...
def main():
    ...
    for i, seed in enumerate(SEEDS):
        ...
        acc, loss = run_single_seed(
            seed=seed,
            config=config,
            model_builder_fn=build_resnet18_model,
